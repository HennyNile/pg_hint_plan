 ...
 * 	
 * 	public functions:
 * 	   add_paths_to_joinrel(): no modification
 * 
 *  static functions:
 *     sort_inner_and_outer(): no modification
 *     try_mergejoin_path(): call modified for cost estimation of merge join
 *     try_partial_mergejoin_path(): no modification
 *     match_unsorted_outer(): no modification
 *     try_nestloop_path(): call modified for cost estimation of nestloop join
 *     generate_mergejoin_paths(): no modification
 *     consider_parallel_nestloop(): no modification
 *     consider_parallel_mergejoin(): no modification
 *     hash_inner_and_outer(): no modification
 *     try_hashjoin_path(): call modified for cost estimation of hash join
 *     try_partial_hashjoin_path(): call modified for cost estimation of hash join
 *
