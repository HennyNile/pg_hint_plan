...
/*
 * Force to include the disable_cost in the priliminary estimation of cost if merge join is disabled.
 */
void
initial_cost_mergejoin_wrapper(PlannerInfo *root, JoinCostWorkspace *workspace,
							   JoinType jointype,
					   		   List *mergeclauses,
...
/*
 * Force to include the disable_cost in the priliminary estimation of cost if nestloop join is disabled.
 */
void
initial_cost_nestloop_wrapper(PlannerInfo *root, JoinCostWorkspace *workspace,
					  JoinType jointype,
					  Path *outer_path, Path *inner_path,
					  JoinPathExtraData *extra)
{
...
/*
 * Force to include the disable_cost in the priliminary estimation of cost if hash join is disabled.
 */
void
initial_cost_hashjoin_wrapper(PlannerInfo *root, JoinCostWorkspace *workspace,
					  JoinType jointype,
					  List *hashclauses,
					  Path *outer_path, Path *inner_path,
					  JoinPathExtraData *extra,
...
#define initial_cost_mergejoin initial_cost_mergejoin_wrapper
#define initial_cost_nestloop initial_cost_nestloop_wrapper
#define initial_cost_hashjoin initial_cost_hashjoin_wrapper
